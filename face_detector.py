...
class Detector:
    def __init__(self):
        ...
        onnx_path = os.path.join(os.path.dirname(__file__), "models/version-RFB-320.onnx")
        self.sess = ort.InferenceSession(onnx_path, sess_options=self.sess_options)
        self.input_name = self.sess.get_inputs()[0].name

    def detect(self, orig_image):
        # cv2.imwrite("rrrr.png",orig_image)
        # return 1
